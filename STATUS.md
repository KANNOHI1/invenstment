...
- 200万円ロマン枠の投資候補ショートリストv0を`watchlist\romance_portfolio_shortlist_2026-05-12.md`に作成済み。現時点の第1群は`MU`、`POWL`、`FORM`、`IREN`、`OSS`。初回60万円の仮配分は`MU`15万円、`POWL`12万円、`FORM`10万円、`IREN`13万円、`OSS`5万円、現金5万円。
...
- 200万円ロマン枠のポジションサイズと段階的エントリールールはv0作成済み。初回60万円の第1群ショートリストも作成済み。次は売買直前の最新株価・時価総額・注文画面確認、または直近決算通知後の入れ替え。
