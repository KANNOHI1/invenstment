...
## 現在地（2026-08-12・recallはここだけ読めば復元できる）

**フェーズ**: 資金化完了（TSLA/PLTR等5銘柄売却、実現+$6,381/+74%）→ 集中型v1.2で再投下中。目標は非対称な3倍以上。銘柄数は増やさない。

**保有（8/11終値、quoteTime 2026-08-11T20:00Z）**
- IREN 112株 $39.75（平均取得$49.27）— ネオクラウド枠のコア
- NBIS 12株 $193.23（平均取得$201.47）— **POWLへ振り替え中**
- MU 2株 $868.52
- SIMO 10株 $224.00（平均取得$254.85）— 転換社債で「グレー」再分類、売却ライン終値$209.68
- MOD 6株 $198.32
- 現金 約$9,900＋¥320,587（**予備費¥100万は死守**）

**執行待ち（8/12）**
1. NBIS 12株・指値$205・当日有効。約定しなければ同セッション引け前（5:00 JST）に成行。
2. POWL 15株・指値$208（新規・スクリーン総合1位）
3. MOD 4株・指値$198（→合計10株）

**次の判断日**
- 8/17 NBIS Vineland審理（売却完了後は無関係）
- **8/26 NVIDIA決算＝仮説Dのkillスイッチ点検**
- 8月下旬〜9月 Anthropic豪州入札決着 → IREN追撃$1,500

**参照すべきファイル**
- `watchlist/banmen_state.md` — 盤面の差分基準（毎回読む）
- `watchlist/thesis_register.md` — 仮説A/B/C/Dと反証条件（毎回読む）
- `watchlist/kansei_handan_2026-08-12.md` — 直近の完成判断
- `watchlist/equipment_side_screen_2026-08-12.md` — 装備側スクリーン（新ウォッチ: CAMT→AAOI→STRL/IESC→NVT）
- `AGENTS.md` — 役割定義・トークン運用ルール・口座の事実（SBI、時間外非対応）
