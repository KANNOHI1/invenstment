...
- 現在のポジション: `IREN` 112株（平均取得$49.27）、`NBIS` 12株、`MU` 2株、**`SIMO` 10株（平均取得$254.85。8/5に6株を$259.00で約定）**、`MOD` 6株。次の判定: NBIS 8/12決算（三択判定。8/6説は否定され会社IRで8/12確定）、Anthropic豪州入札（8月中旬）。
