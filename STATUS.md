...
## 現在地（2026-09-11・recallはここだけ読めば復元できる）
...
**相場観（9/10終値 quoteTime 2026-09-10T20:00:01Z）: 逆金融相場8日連続・象限移動なし・主役エネルギーで序列一致8日連続。**9/10は原油が1日で+8.3%して**$104.04**、10年金利4.94、VIX 17.84と3計器が同時に跳ね、**全9銘柄が下落して評価 $14,478→$13,941（-3.7%）**。**最大の情報: 原油+8%の日に主役XLEが-0.6%で下げた**——序列1位が「他が下げた分の相対1位」に変質しつつあり主役交代の前兆でありうる。明日以降、原油とXLEの乖離を毎回見る。情報技術は2位→5位（半導体13週-15.1%）。MUは$1,000割れ（Netlist特許訴訟の再浮上＋グロース売り。DRAM現物は堅調）。**今夜 9/11 21:30 JST の8月CPIが単独の決定要因**（コンセンサス: コア前年比+2.4%・総合+3.4%。FOMCブラックアウト中で要人発言なし）。詳細は `watchlist/rotation_state.md` の 2026-09-11 追記。
